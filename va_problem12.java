...
public class va_problem12 extends AppCompatActivity {

    final String url = "http://140.127.208.88:81/AppTest/va_problem12.php";
    String problemtp;
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i1 = new Intent(va_problem12.this , MainActivity.class) ;
        startActivity(i1);
