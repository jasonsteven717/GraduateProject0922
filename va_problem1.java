...
public class va_problem1 extends AppCompatActivity {

    final String url = "http://140.127.208.88:81/AppTest/va_problem.php";
    String problemtp;
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i1 = new Intent(va_problem1.this , MainActivity.class) ;
        startActivity(i1);
